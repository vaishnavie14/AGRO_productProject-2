...
$sql = "INSERT INTO checkout VALUES ('$name', '$email', '$mobile', '$address', 'CASH ON DELIVERY')";

  $rs = mysqli_query($con, $sql);

$to_email = "$email";
$subject = "Order Placed Successfully"; 
$body = "Hi $name, We have received your order. Please pay the due amount at the time of delivery as you have chosen to pay with CASH ON DELIVERY.  We are working hard to deliver your order on time.";
$headers = "From: projectp2intern@gmail.com";

if (mail($to_email, $subject, $body, $headers)) {
    echo "$name, we have received your order and it will be delivered soon.";
